...
fun getPitanjaData(): List<Pitanje>{
    return listOf(
        ...
        Pitanje("RPR_P", "Ocijenite predavanje: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),
        Pitanje("RPR_V", "Ocijenite vjezbe: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),
        Pitanje("RPR_O", "Ukupna ocjena predmeta: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),

        Pitanje("TP_P", "Ocijenite predavanje: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),
        Pitanje("TP_V", "Ocijenite vjezbe: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),
        Pitanje("TP_O", "Ukupna ocjena predmeta: ", listOf("Ocjena 1", "Ocjena 2", "Ocjena 3", "Ocjena 4", "Ocjena 5")),
